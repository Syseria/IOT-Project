...
void A121_init()
{
  ...
  while (1)
  {
    ...
    Serial.print("A121_Get_Application_Status: 0x");
    Serial.println(value, HEX);
...
void A121_Get_Cargo_application()
{
  ...
  // Serial.print("A121_Get_Result_Header: 0x");
  // Serial.println(value, HEX);

  if (value & UTILIZATION_LEVEL_VALID)
  {
    A121_Get_Utilization_Distance(&value);
    Serial.print("A121_Get_Utilization_Distance: ");
    Serial.println(value);

    A121_Get_Utilization_Level_Mm(&value);
    Serial.print("A121_Get_Utilization_Level_Mm: ");
    Serial.print(value);
    Serial.println(" mm");

    A121_Get_Utilization_Level_Percent(&value);
    Serial.print("A121_Get_Utilization_Level_Percent: ");
    Serial.print(value);
    Serial.println(" %");
    Serial.println();
  }
